                ...
                <div className="relative overflow-hidden">
                    ...
                    <div>
                        <label className="block">
                            <input className="placeholder-gray-500 border rounded-md   px-2 py-2 my-4 w-80 " placeholder="Email address" />
                        </label>
                    </div>
                    <div>
                        <label className="block">
                            <input type="password" className="placeholder-gray-500 rounded-md w-80 border px-2 py-2 my-2  " placeholder="Password" />
                        </label>
                    </div>

                    <div>
                        <label className="block">
                            <input className="placeholder-gray-500 border rounded-md   px-2 py-2 my-4 w-80 " placeholder="First Name" />
                        </label>
                    </div>

                    <div>
                        <label className="block">
                            <input className="placeholder-gray-500 border rounded-md   px-2 py-2 my-4 w-80 " placeholder="Last Name" />
                        </label>
                    </div>
                    ...
                    <button type="button" className=" w-80 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 my-4 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">JOIN US</button>
                    <div>
                        Not a Member?
