...
<div class="max-w-screen-xl p-8 mx-auto border border-slate-950 rounded-3xl  my-6">
    <h2 class="mb-12 text-3xl font-extrabold leading-9 text-gray-900 border-b-2 border-gray-400">
        FAQs
    </h2>
